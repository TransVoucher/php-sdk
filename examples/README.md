...
This directory contains runnable examples demonstrating how to use the TransVoucher PHP SDK.
...
```bash
export TRANSVOUCHER_API_KEY="your-api-key"
export TRANSVOUCHER_API_SECRET="your-api-secret"
```
...
- [API Documentation](https://transvoucher.com/api-documentation)
