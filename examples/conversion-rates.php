...
$transvoucher = new TransVoucher([
    'api_key' => getenv('TRANSVOUCHER_API_KEY') ?: 'your-api-key',
    'api_secret' => getenv('TRANSVOUCHER_API_SECRET') ?: 'your-api-secret',
    'environment' => 'sandbox', // or 'production'
]);

echo "=== TransVoucher Conversion Rate Example ===" . PHP_EOL . PHP_EOL;
