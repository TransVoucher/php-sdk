...
class CommodityTest extends TestCase
{
    public function testFromArrayCreatesInstanceWithAllFields()
    {
        $data = [
            'short_code' => 'USDT',
            'name' => 'Tether USD',
            'icon_url' => 'https://transvoucher.com/storage/commodities/USDT.webp',
        ...
        $this->assertEquals('https://transvoucher.com/storage/commodities/USDT.webp', $commodity->icon_url);
    ...
    public function testFromArrayWithNativeToken()
    {
        $data = [
            'short_code' => 'MATIC',
            'name' => 'Polygon',
            'icon_url' => 'https://transvoucher.com/storage/commodities/MATIC.webp',
    ...
    public function testToArrayReturnsAllFields()
    {
        ...
        $this->assertEquals('https://transvoucher.com/storage/commodities/USDT.webp', $array['icon_url']);
    ...
    public function testGettersReturnCorrectValues()
    {
        ...
        $this->assertEquals('https://transvoucher.com/storage/commodities/USDT.webp', $commodity->getIconUrl());
