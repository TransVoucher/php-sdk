...
class NetworkTest extends TestCase
{
    public function testFromArrayCreatesInstanceWithAllFields()
    {
        $data = [
            ...
            'icon_url' => 'https://transvoucher.com/storage/networks/POL.webp',
            'is_testnet' => false,
        ];
        ...
        $this->assertEquals('https://transvoucher.com/storage/networks/POL.webp', $network->icon_url);
    ...
    public function testToArrayReturnsAllFields()
    {
        ...
        $this->assertEquals('https://transvoucher.com/storage/networks/POL.webp', $array['icon_url']);
    ...
    public function testGettersReturnCorrectValues()
    {
        ...
        $this->assertEquals('https://transvoucher.com/storage/networks/POL.webp', $network->getIconUrl());
