...
class CommodityServiceTest extends TestCase
{
    ...
    public function testAllReturnsArrayOfCommodities()
    {
        $responseData = [
            'data' => [
                ...
                [
                    'short_code' => 'USDC',
                    'name' => 'USD Coin',
                    'icon_url' => 'https://transvoucher.com/storage/commodities/USDC.webp',
                    'current_usd_value' => '1.00000000',
        ...
        $this->assertEquals('https://transvoucher.com/storage/commodities/USDT.webp', $commodities[0]->icon_url);
